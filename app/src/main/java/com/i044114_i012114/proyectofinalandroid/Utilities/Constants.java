...
public class Constants {
    ...
    public static final String TABLA_FIELD_ID_PEDI = "id_pedi";
    public static final String TABLA_FIELD_ID_USUA = "id_usua";
    public static final String TABLA_FIELD_ID_PRODUC= "id_produc";
    public static final String TABLA_FIELD_ID_CANTIDAD_PEDIDO= "canti_pedido";
    public static final String TABLA_FIELD_ID_DIRECCION= "direc";
    public static final String CREATE_TABLE_PEDIDO =
            "CREATE TABLE "+ TABLA_NAME_PEDIDO+" ("+
                    TABLA_FIELD_ID_PEDI+" INTEGER PRIMARY KEY AUTOINCREMENT, "+
                    TABLA_FIELD_ID_USUA+" INTEGER, "+
                    TABLA_FIELD_ID_PRODUC+" INTEGER, "+
                    TABLA_FIELD_ID_CANTIDAD_PEDIDO+" INTEGER, "+
                    TABLA_FIELD_ID_DIRECCION+" TEXT) ";
}
